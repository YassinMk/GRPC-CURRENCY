...
public class BankGrpcService extends BankServiceGrpc.BankServiceImplBase{
    ...
    @Override
    public StreamObserver<Bank.ConvertCurrencyRequest> performSream(StreamObserver<Bank.ConvertCurrencyResponse> responseObserver) {
